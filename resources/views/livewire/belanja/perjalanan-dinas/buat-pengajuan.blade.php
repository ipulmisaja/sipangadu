...
<div class="main-content">
    ...
    <section class="section" style="z-index:0">
        ...
        <div class="section-header">
            <p class="h3">Pengajuan Perjalanan Dinas</p>
        </div>
                ...
                <div class="col-12">
                    <form wire:submit.prevent="save">
                        <div class="bg-white border-left border-top border-right rounded-top">
                            <div class="p-5">
                                {{-- Tanggal Pengajuan Perjalanan --}}
                                <div class="row">
                                    <div class="col-3">Tanggal Pengajuan Perjalanan Dinas</div>
                                    <div class="col-9">
                                ...
                                {{-- Informasi Pegawai Perjalanan Dinas --}}
                                <div class="row">
                                    <div class="col-12">
                                        <label for="">Informasi Pegawai yang Akan Melakukan Perjalanan Dinas</label>
                                            ...
                                            <div class="card-body">
                                                <div class="table-responsive">
                                                    <table class="table table-striped table-bordered">
                                                        ...
                                                        @foreach ($tripList as $index => $personTrip)
                                                            <tr>
                                                                <td>
                                                                    <div class="input-group">
                                                                        <div class="input-group-prepend">
                                                                        ...
                                                                        {{-- FIXME: bermasalah dengan user yang belum alokasi perjadin --}}
                                                                        <select wire:model.lazy="tripList.{{ $index }}.employee" class="form-control">
                                                                            <option>- Pilih Pegawai -</option>
                                                                            {{-- @foreach ($employees as $person)
                                                                                <option value="{{ $person->user_id }}">{{ $person->nama ?? $person->userRelationship->nama }}</option>
                                                                            @endforeach --}}
                                                                            @foreach ($employees as $person)
                                                                ...
                                                                <td>
                                                                    <div class="input-group">
                                                                        ...
                                                                        <input wire:model.lazy="tripList.{{ $index }}.destination" type="text" class="form-control">
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <div class="input-group">
                                                                        ...
                                                                        <input wire:model.lazy="tripList.{{ $index }}.tripdate" type="text" class="form-control date">
                                                                    </div>
                                                                </td>
                                                                <td>
