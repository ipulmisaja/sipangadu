@section('title', 'Daftar Pengajuan Paket Meeting')

<div class="main-content">
    <section class="section" style="z-index: 0">
        {{-- Header --}}
        <div class="section-header">
            <p class="h3">Daftar Pengajuan Paket Meeting</p>
        </div>
                ...
                <div class="col-12">
                    <div class="card border rounded">
                        <div class="card-header">
                            <h4>
                                <a href="{{ url(env('APP_URL') . 'belanja/paket-meeting/pengajuan') }}" class="btn btn-icon icon-left btn-primary text-white">
                                    <i class="fa fa-plus"></i>
                                    Ajukan Paket Meeting
                                </a>
                            </h4>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12">
                                    @if ($listPaketMeeting->count() > 0)
                                                ...
                                                <tbody>
                                                    ...
                                                    @foreach ($listPaketMeeting->paginate(20) as $item)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a
                                                                    href="{{ url(env('APP_URL') . 'belanja/paket-meeting/detail/' . $item->reference_id) }}"
                                                                    type="button"
                                        ...
                                        <div class="mt-3">
                                            {{ $listPaketMeeting->paginate(20)->links('vendor.pagination.sipangadu') }}
                                        </div>
                                    @else
